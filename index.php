...
$querySection3 = $db->prepare('Select * from contact_section  limit 1');
$querySection3->execute();
$contactSection = $querySection3->fetch();
...
<g transform="translate(0.000000,749.000000) scale(0.100000,-0.100000)">
    ...
    <div class="wrapper">
        ...
        <div class="blurb">
            ...
            <p><?=$section2['text']?></p>
            <div class="social"><a href="<?=$section2['facebook']?>"><i class="icon-facebook"></i></a><a href="<?=$section2['instagram']?>"><i class="icon-instagram"></i></a><a href="<?=$section2['twitter']?>"><i class="icon-twitter"></i></a><a href="pinterest"><i class="icon-pinterest-p"></i></a></div>
        </div>
    </div>
</section>
...
<g transform="translate(0.000000,749.000000) scale(0.100000,-0.100000)">
    ...
    <div class="wrapper">
        <div class="blurb">
            <h2><strong><?= $section3['title'] ?></strong> ad minim</h2>
            <p><?= $section3['text'] ?></p>
        </div>
...
<g transform="translate(0.000000,750.000000) scale(0.100000,-0.100000)">
    ...
    <div class="wrapper">
        <div class="blurb">
            <h2><strong><?= $contactSection['title'] ?></h2>
            <p><?= $contactSection['text'] ?></p>
        </div>
        <form action="admin/functions/form.functions.php" method="POST">
